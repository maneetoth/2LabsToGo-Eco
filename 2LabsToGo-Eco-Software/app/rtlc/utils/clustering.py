...
def get_labels(num_clusters, latents, random_state =32):
...
# In clustering.py
def perform_clustering(model_weights_path=MODEL_WEIGHTS_PATH, name_of_images: list = None, dimentions=3, cluster_file_name=None):
    # 1. Get the data
    ...
    labels = get_labels(num_clusters, latent_model) #[cite: 3]
